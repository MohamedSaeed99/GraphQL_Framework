...
//      println(node)
  ...
  "A Repo Query" should "be able to filtered on the number of commits AFTER being executed" in {
    ...
    val commitFilteredResults: List[Node] = built1Response.filter(Commits(_)(_>200).compare())
...
//      println(node)
  ...
  "A Repo Query" should "be able to filtered on the number of Issue AFTER being executed" in {
    ...
    val commitFilteredResults: List[Node] = built1Response.filter(Issue(_)(_>200).compare())
